...
pub use string::{
    ...
    EndsWithFunction, FromHexFunction, InstrFunction, LeftFunction, LengthFunction, LocateFunction,
    LowerFunction, LpadFunction, LtrimFunction, PositionFunction, RepeatFunction, ReplaceFunction,
...
pub fn value_to_string(value: &Value) -> String {
    ...
    value.as_string().unwrap_or_else(|| value.to_string())
}
