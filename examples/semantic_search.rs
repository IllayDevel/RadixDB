...
//!
//! Demonstrates RadixDB's built-in `EMBED()` function for semantic search:
...
fn main() {
    println!();
    print_separator(76);
    println!("  RADIXDB SEMANTIC SEARCH ENGINE");
