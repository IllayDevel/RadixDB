...
//! Self-contained ANN benchmark for RadixDB HNSW vector search.
//!
//! Downloads the Fashion-MNIST dataset, computes exact ground truth,
//! inserts vectors into RadixDB, and measures recall + throughput
...
const CACHE_DIR_NAME: &str = "radixdb-ann-benchmark";
