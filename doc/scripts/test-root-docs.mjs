...
assert.deepEqual(releases(read('CHANGELOG.md')), [
  '1.2.25:2026-09-14', '1.2.21:2026-09-14', '1.2.19:2026-09-14',
  '1.1.0:2026-09-08', '1.0.0:2026-09-07',
]);
...
for (const relative of ['README.md', 'README.ru.md']) {
  assert(read(relative).includes('1.2.25'), `${relative} does not name current release`);
}
