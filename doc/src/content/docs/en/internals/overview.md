...
description: Crate ownership, request path and state lifetimes in RadixDB 1.2.4.
---

This chapter is a map of the implemented RadixDB 1.2.4 architecture. It explains
