...
The verified RadixDB 1.2.19 source baseline uses protocol 18. Confirm the server
identity before starting it; a local source build currently reports application
version 1.2.19 together with its full Git revision and protocol version.
