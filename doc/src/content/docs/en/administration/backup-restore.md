...
description: Create a consistent RadixDB 1.2.25 backup, keep it outside the database root, and restore it into a new directory.
---
...
```sh
BUNDLE=/srv/radixdb-releases/1.2.25
...
the 1.2.25 snapshot are restored; a snapshot format that explicitly omits a
