...
description: Hot MVCC rows, immutable V6 data artifacts, row groups, compression, checkpoints and compaction in RadixDB 1.2.19.
---

RadixDB 1.2.19 uses a hybrid storage model. Recent changes live in mutable MVCC
...
This chapter describes the V6 implementation used by the RadixDB 1.2.19 source
...
The 1.2.19 server TOML does not expose a compression switch. Embedded file DSNs do
