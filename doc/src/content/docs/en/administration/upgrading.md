...
This procedure is verified against the frozen RadixDB 1.2.25 release source.
...
RadixDB 1.2.25 has no `ALTER EXTENSION UPDATE`, hot reload or automatic codec
...
5. Define an application write stop. RadixDB 1.2.25 does not provide replication,
