---
title: Limits
description: Structural ceilings, configurable admission limits and measured scale for RadixDB 1.2.25.
---
...
- **Hard limit**: a format or semantic ceiling enforced by the 1.2.25 code.
...
These limits belong to plugin ABI 1.0 and the 1.2.25 startup loader. They are not
