...
description: Accepted benchmark, resource-use and reliability evidence distributed with the RadixDB 1.2.25 manual.
---
...
| [RadixDB 1.2.4 100M validation](../../../evidence/performance/RADIXDB_1_2_100M_VALIDATION.md) | Historical-source checksum, elapsed time, RSS and allocated size |
