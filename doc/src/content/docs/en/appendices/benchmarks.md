---
title: Benchmarks
description: Reproducible performance and reliability evidence for the RadixDB 1.2.19 documentation line.
---
...
| BENCH-03 | Historical 1.2.4 100M verification | `23bf35df011aae6816d77578be96074b02bc363c` | 2026-09-09 | Canonical NVMe run on device `nvme1n1` | [1.2.4 validation report](../../../evidence/performance/RADIXDB_1_2_100M_VALIDATION.md) |
...
## Historical 1.2.4 verification

The recorded 1.2.4 source baseline reran the canonical 100-million-row NVMe check.
...
This run verifies the recorded source, not the 1.2.19 release. It is retained
