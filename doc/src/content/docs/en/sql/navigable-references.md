...
Persisted view definitions containing navigation are not supported in 1.2.21:
...
RadixDB 1.2.21 does not accept composite foreign-key DDL. Cross-database paths and
