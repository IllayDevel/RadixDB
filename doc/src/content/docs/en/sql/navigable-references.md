...
Persisted view definitions containing navigation are not supported in 1.2.25:
...
RadixDB 1.2.25 does not accept composite foreign-key DDL. Cross-database paths and
