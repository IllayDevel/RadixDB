...
Persisted view definitions containing navigation are not supported in 1.2.19:
...
RadixDB 1.2.19 does not accept composite foreign-key DDL. Cross-database paths and
