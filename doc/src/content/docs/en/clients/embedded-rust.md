...
directory and its lifecycle. This chapter describes the 1.2.19 public API exposed
...
example path with the checked-out 1.2.19 source used by the application:
