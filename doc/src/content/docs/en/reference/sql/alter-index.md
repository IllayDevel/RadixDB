...
Version 1.2.19 supports only RENAME TO. The index method, columns, predicate and
...
changing method and changing indexed columns are not ALTER INDEX forms in 1.2.19.
