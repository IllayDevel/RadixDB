...
The 1.2.21 execution contract requires the ON table clause even though the parser
...
Omitting `ON table_name` is rejected in 1.2.21. A mismatched table, missing index
