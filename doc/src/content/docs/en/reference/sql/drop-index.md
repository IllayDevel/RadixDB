...
The 1.2.25 execution contract requires the ON table clause even though the parser
...
Omitting `ON table_name` is rejected in 1.2.25. A mismatched table, missing index
