...
description: Syntax and execution contracts for SQL commands verified in RadixDB 1.2.21.
---

This reference describes the SQL command surface verified for RadixDB 1.2.21 at
