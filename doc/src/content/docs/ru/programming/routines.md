...
Принятые tests 1.2.25 пересобирают routines из source после persistent reopen.
...
Необязательный clause `RESOURCE POLICY` в 1.2.25 принимает только встроенное имя
