...
Руководство 1.2.4 соответствует текущему снимку исходников 1.2.4 и wire
protocol 17. Согласованные crates workspace и бинарники сообщают Cargo package
version 1.2.4. До создания формального release tag связывайте бинарник с точной
ревизией исходников и lockfile по полной build identity.
...
Версия 1.2.4 добавляет stable C ABI 1.0, безопасный Rust authoring SDK и
...
описанную ниже. Ограничения раздела относятся к 1.1, а не к текущей ветке 1.2.4.
