---
title: Ограничения
description: Структурные пределы, настраиваемые ограничения и измеренный масштаб RadixDB 1.2.21.
---
...
- **Жёсткий предел**: ограничение формата или семантики, проверяемое кодом 1.2.21.
...
Эти limits принадлежат plugin ABI 1.0 и startup loader 1.2.21. Они не являются
