...
description: Владельцы crates, путь запроса и время жизни состояния в RadixDB 1.2.4.
---

Эта глава представляет карту реализованной архитектуры RadixDB 1.2.4. Она
