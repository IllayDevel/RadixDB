...
description: Principals, roles, ownership и object или column privileges в RadixDB 1.2.21.
---
...
RadixDB 1.2.21 не реализует row-level security и `CREATE POLICY`. Также нет grants
