...
description: Principals, roles, ownership и object или column privileges в RadixDB 1.2.19.
---
...
RadixDB 1.2.19 не реализует row-level security и `CREATE POLICY`. Также нет grants
