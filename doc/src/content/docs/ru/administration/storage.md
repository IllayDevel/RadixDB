...
description: Hot MVCC-строки, неизменяемые V6-артефакты, группы строк, сжатие, checkpoint и compaction в RadixDB 1.2.21.
---

RadixDB 1.2.21 использует гибридную модель хранения. Последние изменения находятся
...
Глава описывает реализацию V6 из базы исходников RadixDB 1.2.21
...
Server TOML 1.2.21 не предоставляет переключатель сжатия. Embedded file DSN
