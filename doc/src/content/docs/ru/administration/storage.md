...
description: Hot MVCC-строки, неизменяемые V6-артефакты, группы строк, сжатие, checkpoint и compaction в RadixDB 1.2.25.
---

RadixDB 1.2.25 использует гибридную модель хранения. Последние изменения находятся
...
Глава описывает реализацию V6 из базы исходников RadixDB 1.2.25
...
Server TOML 1.2.25 не предоставляет переключатель сжатия. Embedded file DSN
