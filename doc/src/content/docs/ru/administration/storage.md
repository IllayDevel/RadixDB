...
description: Hot MVCC-строки, неизменяемые V6-артефакты, группы строк, сжатие, checkpoint и compaction в RadixDB 1.2.4.
---

RadixDB 1.2.4 использует гибридную модель хранения. Последние изменения находятся
...
Глава описывает реализацию V6 из базы исходников RadixDB 1.2.4
...
Server TOML 1.2.4 не предоставляет переключатель сжатия. Embedded file DSN
