...
Контракт выполнения 1.2.25 требует секцию ON table, хотя парсер способен представить
...
Отсутствие `ON table_name` отклоняется в версии 1.2.25. Ошибка возникает также при
