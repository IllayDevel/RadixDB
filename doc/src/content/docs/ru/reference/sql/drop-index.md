...
Контракт выполнения 1.2.4 требует секцию ON table, хотя парсер способен представить
...
Отсутствие `ON table_name` отклоняется в версии 1.2.4. Ошибка возникает также при
