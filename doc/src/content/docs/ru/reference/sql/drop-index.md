...
Контракт выполнения 1.2.21 требует секцию ON table, хотя парсер способен представить
...
Отсутствие `ON table_name` отклоняется в версии 1.2.21. Ошибка возникает также при
